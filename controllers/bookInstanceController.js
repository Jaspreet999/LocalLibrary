...
exports.bookinstance_delete_get = function(req, res, next) {
    ...
    .exec(function(err,book_instances){
        ...
        res.render('bookinstances_delete',{title:"Delete Book Instance",book_instance:book_instances})
    })
};
...
exports.bookinstance_update_get = function(req, res) {
    async.parallel({
        ...
        res.render('bookinstance_form',{title:"Update Book Instance", book_list:results.book,
